        ...
        <Form onSubmit={onSubmit} className="justify-content-center gy-3">
            <Col>
                <InputGroup className="justify-content-center">
                    ...
                    <Button type="submit" variant="primary" id="form-amount-prepend-1" className="d-none d-sm-block" disabled={loading}>
                        Add To Wallet
                    </Button>
                    <Button type="submit" variant="primary" id="form-amount-prepend-2" className="d-sm-none" disabled={loading}>
                        Add
                    </Button>
                </InputGroup>
            </Col>
